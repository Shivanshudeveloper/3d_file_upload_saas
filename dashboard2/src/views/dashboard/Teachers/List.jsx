...
const List = () => {
  ...
  const editTeacher = async () => {
    await axios
      .patch(`${TEST_API_SERVICE}/editteacherlist`, formData)
      .then((res) => {
        getTeachers();
        handleClose();
        setFormData(initialState);
  ...
  const addTeacher = async () => {
    auth
      ...
      .then(async (userCredential) => {
        await axios
          .post(`${TEST_API_SERVICE}/addteacherlist`, formData)
          .then((res) => {
            getTeachers();
            handleClose();
            setFormData(initialState);
  ...
  const getTeachers = async () => {
    await axios
      .get(`${TEST_API_SERVICE}/getteacherlist`)
  ...
  const getClass = async () => {
    await axios
      .get(`${TEST_API_SERVICE}/getclasslist`)
